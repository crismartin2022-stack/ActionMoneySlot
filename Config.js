// game/Config.js - Versión Completa y Corregida
var com = window.com || {};
com.egt = com.egt || {};
...
var Config = function() {
    ...
    this.labelsColor = MoneyText.textColor = 0x414cc8;
    ...
    // Configuración de los símbolos especiales (scatter)
    this.scatterConfig = [
        {
            index: 9,
            minCount: 3,
            bonusMinCount: 3,
            bonusVideoIndex: 9,
            validReels: [true, true, true, true, true],
        ...
        },
        {
            ...
            minCount: 3,
            freespinMinCount: 3,
            validReels: [false, false, true, true, true],
            freespinVideoIndex: 10,
            freespinSound: "winScatterFs",
            stopSounds: [null, null, "stopScatterSound3", "stopScatterSound4", "stopScatterSound3"]
        }
    ];

    // Rutas a los assets de video e imágenes
    this.reelVideos = [
    ...
    // Coordenadas de las 20 líneas de pago
    this.linesCoords = [
    ...
    // Sonidos del juego principal
    this.gameSounds = [
        {
            src: "assets/sounds/shortSounds.mp3",
            sounds: [
        ...
        {
            src: "assets/sounds/winSounds.mp3",
            sounds: [
    ...
    // Sonidos específicos de las rondas de free spins
    this.freespinSounds = [
        {
